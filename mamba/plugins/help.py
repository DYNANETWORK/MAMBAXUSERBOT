...
🤖 **ʜᴇʏᴀ..!!! 
➖➖➖➖➖➖➖➖➖➖➖➖➖➖
✘ __ɪ'ᴍ ᴀɴ ᴍᴀᴍʙᴀ ᴜsᴇʀʙᴏᴛ. ɪ ᴄᴀɴ ᴘʟᴀʏ ᴍᴜsɪᴄ ᴛʜʀᴏᴡ ᴜsᴇʀʙᴏᴛ. ɪ ᴄᴀɴ sᴘᴀᴍ ᴍsɢ ᴀɴʏ ᴍᴀɴʏ ᴍᴏʀᴇ . ɪ ʜᴀᴠᴇ ʟᴏᴛꜱ ᴏꜰ ꜰᴇᴀᴛᴜʀᴇꜱ ᴡʜɪᴄʜ ʏᴏᴜ ʟɪᴋᴇꜱ ᴛʜᴀᴛ__.
➖➖➖➖➖➖➖➖➖➖➖➖➖➖
✘ __ᴄʟɪᴄᴋ ᴏɴ ʜᴇʟᴘ ʙᴜᴛᴛᴏɴ ꜰᴏʀ ᴍᴏʀᴇ ɪɴꜰᴏʀᴍᴀᴛɪᴏɴ ℹ️__.
"""
    buttons = [
            [
                InlineKeyboardButton("✘ ꜱᴜᴘᴘᴏʀᴛ", url=f"https://t.me/MAMBA_X_SUPPORT"),
                InlineKeyboardButton("✘ ᴄʜᴀɴɴᴇʟ", url=f"https://t.me/MAMBA_X_NETWORK"),
            ],
            [
                InlineKeyboardButton("✘ ꜱᴏᴜʀᴄᴇ ᴄᴏᴅᴇ", url="https://www.pornhub.com"),
                InlineKeyboardButton("✘ ᴅᴇᴠᴇʟᴏᴘᴇʀ", url="https://t.me/ITS_BLACKMAMBA"),
            ],
            [
    ...
    await message.reply_photo(photo=f"https://telegra.ph/file/1bb20c5dddcc3bb39ebbf.jpg", caption=HOME_TEXT, reply_markup=reply_markup)
    await message.delete()
    
@bot.on_message(filters.command(["help"], ["/", "$"]))
def help_(Client, message: Message):
    HELP_TXT = """🤖 ʜᴏɪ..!!! 
__ʜᴇʀᴇ ɪs ᴛʜᴇ ʜᴇʟᴘ ᴍᴇɴᴜ ᴄʜᴏᴏsᴇ ʏᴏᴜʀ ᴅᴇsɪʀᴇ ᴏᴘᴛɪᴏɴ ɴᴅ ᴇxᴘʟᴏʀᴇ ɪᴛ. \nғᴏʀ ᴀɴʏ ᴋɪɴᴅ ᴏғ ʜᴇʟᴘ ᴏʀ ǫᴜᴇʀʏ ᴊᴜsᴛ ᴊᴏɪɴ @MAMBA_X_NETWORK ᴀɴᴅ ᴀsᴋ ʏᴏᴜʀ ǫᴜᴇʀʏ. __"""
    
    message.reply_photo(
        photo="https://telegra.ph/file/1bb20c5dddcc3bb39ebbf.jpg",
        caption=HELP_TXT,
...
"""
        BUTTON = [
            [
                InlineKeyboardButton("✘ ꜱᴜᴘᴘᴏʀᴛ", url=f"https://t.me/MAMBA_X_SUPPORT"),
                InlineKeyboardButton("✘ ᴄʜᴀɴɴᴇʟ", url=f"https://t.me/MAMBA_X_SUPPORT"),
            ],
            [
                InlineKeyboardButton("✘ ꜱᴏᴜʀᴄᴇ ᴄᴏᴅᴇ", url="https://www.pornhub.com"),
                InlineKeyboardButton("✘ ᴅᴇᴠᴇʟᴏᴘᴇʀ", url="https://t.me/ITS_BLACKMAMBA"),
